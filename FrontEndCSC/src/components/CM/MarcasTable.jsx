        ...
        <table className="w-full">
          <thead className="uppercase">
            <tr className="bg-gradient-to-r from-stone-700 via-stone-600 to-stone-700">
              ...
              <th className="px-6 py-3 text-left text-xs font-semibold text-white">
                <div className="flex items-center">
                  <span className="py-1 px-2.5 text-sm text-white">País</span>
                  <div
                    className="relative"
              ...
              <th className="px-6 py-3 text-left text-xs font-semibold text-white">
                <div className="flex items-center">
                  <span className="py-1 px-2.5 text-sm text-white">Clase</span>
                  <div
                    className="relative"
              ...
              <th className="px-6 py-3 text-left text-xs font-semibold text-white">
                <div className="flex items-center">
                  <span className="py-1 px-2.5 text-sm text-white">Estado</span>
                  <div
                    className="relative"
              ...
              <th className="px-6 py-3 text-left text-xs font-semibold text-white">
                <div className="flex items-center">
                  ...
                  <div
                    className="relative"
                    ref={(el) => (dropdownRefs.current.Marc_Renovacion = el)}
                  >
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
